...
update_test_genesis '.app_state["mint"]["params"]["mint_denom"]=$DENOM' udotest
update_test_genesis '.app_state["gov"]["deposit_params"]["min_deposit"]=[{"denom": $DENOM,"amount": "1000000"}]' udotest
update_test_genesis '.app_state["crisis"]["constant_fee"]={"denom": $DENOM,"amount": "1000"}' udotest
update_test_genesis '.app_state["staking"]["params"]["bond_denom"]=$DENOM' udotest
