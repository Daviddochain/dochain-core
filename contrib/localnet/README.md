...
1. Keys
The simulation will add these normal [addresses](simulation/network/localterra/keys.json) to keyring. Query `dochaind keys list --keyring-backend test` to see.
...
2. Processes
* Validator addresses will send udo to normal addresses
