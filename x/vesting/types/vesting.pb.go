...
// source: dochain/vesting/v1beta1/vesting.proto
...
func init() {
	proto.RegisterType((*LazyGradedVestingAccount)(nil), "dochain.vesting.v1beta1.LazyGradedVestingAccount")
	proto.RegisterType((*Schedule)(nil), "dochain.vesting.v1beta1.Schedule")
	proto.RegisterType((*VestingSchedule)(nil), "dochain.vesting.v1beta1.VestingSchedule")
}

func init() {
	proto.RegisterFile("dochain/vesting/v1beta1/vesting.proto", fileDescriptor_c4a9bc06e563192a)
}
