...
var (
	...
	DelegateCoins = sdk.NewCoin(core.MicroDoDenom, InitTokens)
...
func CreateTestInput(t *testing.T) TestInput {
	...
	totalSupply := sdk.NewCoins(sdk.NewCoin(core.MicroDoDenom, math.Int(math.LegacyNewDec(1_000_000_000_000))))
	...
	err = bankKeeper.SendCoinsFromModuleToModule(
		...
		sdk.NewCoins(sdk.NewCoin(core.MicroDoDenom, InitTokens.MulRaw(int64(len(PubKeys))))),
	)
	require.NoError(t, err)
