...
Market module provides swap functionality based on constant product mechanism. do pool have to keep its delta to track the currency demands for swap spread. Luna pool can be retrived from do pool delta with following equation:
