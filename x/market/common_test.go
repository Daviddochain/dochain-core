...
func setup(t *testing.T) (keeper.TestInput, types.MsgServer) {
	...
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroSDRDenom, randomPrice)
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroKRWDenom, randomPrice)
