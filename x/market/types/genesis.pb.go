...
// source: dochain/market/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "dochain.market.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("dochain/market/v1beta1/genesis.proto", fileDescriptor_e30414b001901db3)
}
