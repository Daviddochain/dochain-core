...
type OracleKeeper interface {
	GetDoExchangeRate(ctx sdk.Context, denom string) (price math.LegacyDec, err error)
	GetTobinTax(ctx sdk.Context, denom string) (tobinTax math.LegacyDec, err error)

	// only used for simulation
	IterateDoExchangeRates(ctx sdk.Context, handler func(denom string, exchangeRate math.LegacyDec) (stop bool))
	SetDoExchangeRate(ctx sdk.Context, denom string, exchangeRate math.LegacyDec)
