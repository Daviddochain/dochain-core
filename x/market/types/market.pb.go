...
// source: dochain/market/v1beta1/market.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "dochain.market.v1beta1.Params")
}

func init() { proto.RegisterFile("dochain/market/v1beta1/market.proto", fileDescriptor_114ea92c5ae3e66f) }
