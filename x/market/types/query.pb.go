...
func init() {
	...
	proto.RegisterType((*QueryTerraPoolDeltaRequest)(nil), "do.market.v1beta1.QueryTerraPoolDeltaRequest")
	proto.RegisterType((*QueryTerraPoolDeltaResponse)(nil), "do.market.v1beta1.QueryTerraPoolDeltaResponse")
...
func init() { proto.RegisterFile("do/market/v1beta1/query.proto", fileDescriptor_c172d0f188bf2fb6) }
...
func (c *queryClient) TerraPoolDelta(ctx context.Context, in *QueryTerraPoolDeltaRequest, opts ...grpc.CallOption) (*QueryTerraPoolDeltaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/do.market.v1beta1.Query/TerraPoolDelta", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TerraPoolDelta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/do.market.v1beta1.Query/TerraPoolDelta",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
