...
// source: dochain/market/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSwap)(nil), "dochain.market.v1beta1.MsgSwap")
	proto.RegisterType((*MsgSwapResponse)(nil), "dochain.market.v1beta1.MsgSwapResponse")
	proto.RegisterType((*MsgSwapSend)(nil), "dochain.market.v1beta1.MsgSwapSend")
	proto.RegisterType((*MsgSwapSendResponse)(nil), "dochain.market.v1beta1.MsgSwapSendResponse")
}

func init() { proto.RegisterFile("dochain/market/v1beta1/tx.proto", fileDescriptor_7dcd4b152743bd0f) }
...
func (c *msgClient) Swap(ctx context.Context, in *MsgSwap, opts ...grpc.CallOption) (*MsgSwapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dochain.market.v1beta1.Msg/Swap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SwapSend(ctx context.Context, in *MsgSwapSend, opts ...grpc.CallOption) (*MsgSwapSendResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dochain.market.v1beta1.Msg/SwapSend", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Swap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dochain.market.v1beta1.Msg/Swap",
	}
...
func _Msg_SwapSend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dochain.market.v1beta1.Msg/SwapSend",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dochain.market.v1beta1.Msg",
	...
	Metadata: "dochain/market/v1beta1/tx.proto",
}
