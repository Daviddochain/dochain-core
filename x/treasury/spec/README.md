...
The Treasury module acts as the "central bank" of the do economy, measuring macroeconomic activity by [observing indicators](./01_concepts.md#Observed-Indicators) and adjusting [monetary policy levers](./01_concepts.md#Monetary-Policy-Levers) to modulate miner incentives toward stable, long-term growth.

> While the Treasury stabilizes miner demand through adjusting rewards, the [Market](../market/spec/README.md) is responsible for do price-stability through arbitrage and market maker.
