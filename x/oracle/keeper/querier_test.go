...
func TestQueryExchangeRate(t *testing.T) {
	...
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroSDRDenom, rate)
...
func TestQueryExchangeRates(t *testing.T) {
	...
	rate := sdkmath.LegacyNewDec(1700)
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroSDRDenom, rate)
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroUSDDenom, rate)
...
func TestQueryActives(t *testing.T) {
	...
	rate := sdkmath.LegacyNewDec(1700)
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroSDRDenom, rate)
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroKRWDenom, rate)
	input.OracleKeeper.SetDoExchangeRate(input.Ctx, core.MicroUSDDenom, rate)
...
func TestQueryAggregatePrevote(t *testing.T) {
	...
	prevote1 := types.NewAggregateDoRatePrevote(types.AggregateVoteHash{}, ValAddrs[0], 0)
	input.OracleKeeper.SetAggregateDoRatePrevote(input.Ctx, ValAddrs[0], prevote1)
	prevote2 := types.NewAggregateDoRatePrevote(types.AggregateVoteHash{}, ValAddrs[1], 0)
	input.OracleKeeper.SetAggregateDoRatePrevote(input.Ctx, ValAddrs[1], prevote2)
...
func TestQueryAggregatePrevotes(t *testing.T) {
	...
	prevote2 := types.NewAggregateDoRatePrevote(types.AggregateVoteHash{}, ValAddrs[1], 0)
	input.OracleKeeper.SetAggregateDoRatePrevote(input.Ctx, ValAddrs[1], prevote2)
	prevote3 := types.NewAggregateDoRatePrevote(types.AggregateVoteHash{}, ValAddrs[2], 0)
	input.OracleKeeper.SetAggregateDoRatePrevote(input.Ctx, ValAddrs[2], prevote3)

	expectedPrevotes := []types.AggregateDoRatePrevote{prevote1, prevote2, prevote3}
...
func TestQueryAggregateVote(t *testing.T) {
	...
	vote1 := types.NewAggregateDoRateVote(types.DoRateTuples{{Denom: "", ExchangeRate: sdkmath.LegacyOneDec()}}, ValAddrs[0])
	input.OracleKeeper.SetAggregateDoRateVote(input.Ctx, ValAddrs[0], vote1)
	vote2 := types.NewAggregateDoRateVote(types.DoRateTuples{{Denom: "", ExchangeRate: sdkmath.LegacyOneDec()}}, ValAddrs[1])
	input.OracleKeeper.SetAggregateDoRateVote(input.Ctx, ValAddrs[1], vote2)
...
func TestQueryAggregateVotes(t *testing.T) {
	...
	vote2 := types.NewAggregateDoRateVote(types.DoRateTuples{{Denom: "", ExchangeRate: sdkmath.LegacyOneDec()}}, ValAddrs[1])
	input.OracleKeeper.SetAggregateDoRateVote(input.Ctx, ValAddrs[1], vote2)
	vote3 := types.NewAggregateDoRateVote(types.DoRateTuples{{Denom: "", ExchangeRate: sdkmath.LegacyOneDec()}}, ValAddrs[2])
	input.OracleKeeper.SetAggregateDoRateVote(input.Ctx, ValAddrs[2], vote3)

	expectedVotes := []types.AggregateDoRateVote{vote1, vote2, vote3}
