...
func TestRewardBallotWinners(t *testing.T) {
	...
	// Prepare reward pool
	givingAmt := sdk.NewCoins(sdk.NewInt64Coin(core.MicroDoDenom, 30000000), sdk.NewInt64Coin(core.MicroUSDDenom, 40000000))
	...
	require.Equal(t, sdkmath.LegacyNewDecFromInt(givingAmt.AmountOf(core.MicroDoDenom)).QuoInt64(votePeriodsPerWindow).QuoInt64(3).TruncateInt(),
		outstandingRewards.AmountOf(core.MicroDoDenom))
	...
	require.Equal(t, sdkmath.LegacyNewDecFromInt(givingAmt.AmountOf(core.MicroDoDenom)).QuoInt64(votePeriodsPerWindow).QuoInt64(3).MulInt64(2).TruncateInt(),
		outstandingRewards1.AmountOf(core.MicroDoDenom))
