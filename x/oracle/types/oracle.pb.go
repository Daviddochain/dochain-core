...
func init() {
	...
	proto.RegisterType((*AggregateExchangeRatePrevote)(nil), "do.oracle.v1beta1.AggregateExchangeRatePrevote")
	proto.RegisterType((*AggregateExchangeRateVote)(nil), "do.oracle.v1beta1.AggregateExchangeRateVote")
	proto.RegisterType((*ExchangeRateTuple)(nil), "do.oracle.v1beta1.ExchangeRateTuple")
}

func init() { proto.RegisterFile("do/oracle/v1beta1/oracle.proto", fileDescriptor_2a008582d55f197f) }
