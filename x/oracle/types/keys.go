...
//
// - 0x04<valAddress_Bytes>: AggregateDoRatePrevote
//
// - 0x05<valAddress_Bytes>: AggregateDoRateVote
//
...
var (
	...
	AggregateDoRatePrevoteKey = []byte{0x04} // prefix for each key to a aggregate prevote
	AggregateDoRateVoteKey    = []byte{0x05} // prefix for each key to a aggregate vote
...
// GetAggregateDoRatePrevoteKey - stored by *Validator* address
func GetAggregateDoRatePrevoteKey(v sdk.ValAddress) []byte {
	return append(AggregateDoRatePrevoteKey, address.MustLengthPrefix(v)...)
}

// GetAggregateDoRateVoteKey - stored by *Validator* address
func GetAggregateDoRateVoteKey(v sdk.ValAddress) []byte {
	return append(AggregateDoRateVoteKey, address.MustLengthPrefix(v)...)
}
