...
type QueryExchangeRateResponse struct {
	// exchange_rate defines the exchange rate of Luna denominated in various do
...
func init() { proto.RegisterFile("do/oracle/v1beta1/query.proto", fileDescriptor_198b4e80572a772d) }
