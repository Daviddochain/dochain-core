...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	legacy.RegisterAminoMsg(cdc, &MsgAggregateDoRatePrevote{}, "oracle/MsgAggregateDoRatePrevote")
	legacy.RegisterAminoMsg(cdc, &MsgAggregateDoRateVote{}, "oracle/MsgAggregateDoRateVote")
