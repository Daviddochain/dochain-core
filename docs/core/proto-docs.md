...
- [do/market/v1beta1/query.proto](#do/market/v1beta1/query.proto)
    ...
    - [QueryTerraPoolDeltaRequest](#do.market.v1beta1.QueryTerraPoolDeltaRequest)
    - [QueryTerraPoolDeltaResponse](#do.market.v1beta1.QueryTerraPoolDeltaResponse)
...
- [do/oracle/v1beta1/oracle.proto](#do/oracle/v1beta1/oracle.proto)
    - [AggregateExchangeRatePrevote](#do.oracle.v1beta1.AggregateExchangeRatePrevote)
    - [AggregateExchangeRateVote](#do.oracle.v1beta1.AggregateExchangeRateVote)
    - [Denom](#do.oracle.v1beta1.Denom)
    - [ExchangeRateTuple](#do.oracle.v1beta1.ExchangeRateTuple)
...
- [do/oracle/v1beta1/tx.proto](#do/oracle/v1beta1/tx.proto)
    - [MsgAggregateExchangeRatePrevote](#do.oracle.v1beta1.MsgAggregateExchangeRatePrevote)
    - [MsgAggregateExchangeRatePrevoteResponse](#do.oracle.v1beta1.MsgAggregateExchangeRatePrevoteResponse)
    - [MsgAggregateExchangeRateVote](#do.oracle.v1beta1.MsgAggregateExchangeRateVote)
    - [MsgAggregateExchangeRateVoteResponse](#do.oracle.v1beta1.MsgAggregateExchangeRateVoteResponse)
...
<a name="do.market.v1beta1.QueryTerraPoolDeltaRequest"></a>
...
<a name="do.market.v1beta1.QueryTerraPoolDeltaResponse"></a>
...
| `TerraPoolDelta` | [QueryTerraPoolDeltaRequest](#do.market.v1beta1.QueryTerraPoolDeltaRequest) | [QueryTerraPoolDeltaResponse](#do.market.v1beta1.QueryTerraPoolDeltaResponse) | TerraPoolDelta returns terra_pool_delta amount. | GET|/do/market/v1beta1/terra_pool_delta|
...
<a name="do.oracle.v1beta1.AggregateExchangeRatePrevote"></a>
...
<a name="do.oracle.v1beta1.AggregateExchangeRateVote"></a>

### AggregateExchangeRateVote
MsgAggregateExchangeRateVote - struct for voting on
the exchange rates of Luna denominated in various do assets.


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `exchange_rate_tuples` | [ExchangeRateTuple](#do.oracle.v1beta1.ExchangeRateTuple) | repeated |  |
| `voter` | [string](#string) |  |  |
...
<a name="do.oracle.v1beta1.ExchangeRateTuple"></a>
...
| `exchange_rates` | [ExchangeRateTuple](#do.oracle.v1beta1.ExchangeRateTuple) | repeated |  |
| `miss_counters` | [MissCounter](#do.oracle.v1beta1.MissCounter) | repeated |  |
| `aggregate_exchange_rate_prevotes` | [AggregateExchangeRatePrevote](#do.oracle.v1beta1.AggregateExchangeRatePrevote) | repeated |  |
| `aggregate_exchange_rate_votes` | [AggregateExchangeRateVote](#do.oracle.v1beta1.AggregateExchangeRateVote) | repeated |  |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `aggregate_prevote` | [AggregateExchangeRatePrevote](#do.oracle.v1beta1.AggregateExchangeRatePrevote) |  | aggregate_prevote defines oracle aggregate prevote submitted by a validator in the current vote period |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `aggregate_prevotes` | [AggregateExchangeRatePrevote](#do.oracle.v1beta1.AggregateExchangeRatePrevote) | repeated | aggregate_prevotes defines all oracle aggregate prevotes submitted in the current vote period |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `aggregate_vote` | [AggregateExchangeRateVote](#do.oracle.v1beta1.AggregateExchangeRateVote) |  | aggregate_vote defines oracle aggregate vote submitted by a validator in the current vote period |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `aggregate_votes` | [AggregateExchangeRateVote](#do.oracle.v1beta1.AggregateExchangeRateVote) | repeated | aggregate_votes defines all oracle aggregate votes submitted in the current vote period |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `exchange_rate` | [string](#string) |  | exchange_rate defines the exchange rate of Luna denominated in various do |
...
<a name="do.oracle.v1beta1.MsgAggregateExchangeRatePrevote"></a>
...
<a name="do.oracle.v1beta1.MsgAggregateExchangeRatePrevoteResponse"></a>
...
<a name="do.oracle.v1beta1.MsgAggregateExchangeRateVote"></a>
...
<a name="do.oracle.v1beta1.MsgAggregateExchangeRateVoteResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `AggregateExchangeRatePrevote` | [MsgAggregateExchangeRatePrevote](#do.oracle.v1beta1.MsgAggregateExchangeRatePrevote) | [MsgAggregateExchangeRatePrevoteResponse](#do.oracle.v1beta1.MsgAggregateExchangeRatePrevoteResponse) | AggregateExchangeRatePrevote defines a method for submitting aggregate exchange rate prevote | |
| `AggregateExchangeRateVote` | [MsgAggregateExchangeRateVote](#do.oracle.v1beta1.MsgAggregateExchangeRateVote) | [MsgAggregateExchangeRateVoteResponse](#do.oracle.v1beta1.MsgAggregateExchangeRateVoteResponse) | AggregateExchangeRateVote defines a method for submitting aggregate exchange rate vote | |
