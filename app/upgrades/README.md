...
This folder contains sub-folders for every classic do upgrade. (Both state
...
* (soft-fork) v0.5.20 - Disable swap and IBC [#760](https://github.com/Daviddochain/dochain-core/pull/760)
* (soft-fork) v0.5.21 - Burn Tax and allow Do to be taxed
* (soft-fork) v0.5.22 - Limit validator power to 20% [cosmos-sdk/pull/104](https://github.com/do-money/cosmos-sdk/pull/104)
...
case for all classic do `Fork`s, then all logic changes must be
