# Classic dochain Upgrades

This folder contains sub-folders for every classic dochain upgrade. (Both state
...
* (soft-fork) v0.5.20 - Disable swap and IBC [#760](https://github.com/dochain-money/classic-core/pull/760)
* (soft-fork) v0.5.21 - Burn Tax and allow Luna to be taxed
* (soft-fork) v0.5.22 - Limit validator power to 20% [cosmos-sdk/pull/104](https://github.com/dochain-money/cosmos-sdk/pull/104)
...
case for all classic dochain `Fork`s, then all logic changes must be
