...
// source: dochain/tx/v1beta1/service.proto
...
func init() {
	proto.RegisterType((*ComputeTaxRequest)(nil), "dochain.tx.v1beta1.ComputeTaxRequest")
	golang_proto.RegisterType((*ComputeTaxRequest)(nil), "dochain.tx.v1beta1.ComputeTaxRequest")
	proto.RegisterType((*ComputeTaxResponse)(nil), "dochain.tx.v1beta1.ComputeTaxResponse")
	golang_proto.RegisterType((*ComputeTaxResponse)(nil), "dochain.tx.v1beta1.ComputeTaxResponse")
}

func init() { proto.RegisterFile("dochain/tx/v1beta1/service.proto", fileDescriptor_0b3c73e5d85273f4) }
func init() {
	golang_proto.RegisterFile("dochain/tx/v1beta1/service.proto", fileDescriptor_0b3c73e5d85273f4)
}
...
func (c *serviceClient) ComputeTax(ctx context.Context, in *ComputeTaxRequest, opts ...grpc.CallOption) (*ComputeTaxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dochain.tx.v1beta1.Service/ComputeTax", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_ComputeTax_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dochain.tx.v1beta1.Service/ComputeTax",
	}
...
var _Service_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dochain.tx.v1beta1.Service",
	...
	Metadata: "dochain/tx/v1beta1/service.proto",
}
