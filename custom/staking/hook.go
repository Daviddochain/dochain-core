...
var _ stakingtypes.StakingHooks = &DoStakingHooks{}

// DoStakingHooks implements staking hooks to enforce validator power limit
type DoStakingHooks struct {
	sk stakingkeeper.Keeper
}

func NewDoStakingHooks(sk stakingkeeper.Keeper) *DoStakingHooks {
	return &DoStakingHooks{sk: sk}
}

// Implement required staking hooks interface methods
func (h DoStakingHooks) BeforeDelegationCreated(_ context.Context, _ sdk.AccAddress, _ sdk.ValAddress) error {
	return nil
}

func (h DoStakingHooks) BeforeDelegationSharesModified(_ context.Context, _ sdk.AccAddress, _ sdk.ValAddress) error {
	return nil
}

// Other required hook methods with empty implementations
func (h DoStakingHooks) AfterDelegationModified(ctx context.Context, _ sdk.AccAddress, valAddr sdk.ValAddress) error {
...
func (h DoStakingHooks) BeforeValidatorSlashed(_ context.Context, _ sdk.ValAddress, _ math.LegacyDec) error {
	return nil
}

func (h DoStakingHooks) BeforeValidatorModified(_ context.Context, _ sdk.ValAddress) error {
	return nil
}

func (h DoStakingHooks) AfterValidatorBonded(_ context.Context, _ sdk.ConsAddress, _ sdk.ValAddress) error {
	return nil
}

func (h DoStakingHooks) AfterValidatorBeginUnbonding(_ context.Context, _ sdk.ConsAddress, _ sdk.ValAddress) error {
	return nil
}

func (h DoStakingHooks) AfterValidatorRemoved(_ context.Context, _ sdk.ConsAddress, _ sdk.ValAddress) error {
	return nil
}

func (h DoStakingHooks) AfterUnbondingInitiated(_ context.Context, _ uint64) error {
	return nil
}

// Add this method to DoStakingHooks
func (h DoStakingHooks) AfterValidatorCreated(_ context.Context, _ sdk.ValAddress) error {
	return nil
}

// Add the missing method
func (h DoStakingHooks) BeforeDelegationRemoved(_ context.Context, _ sdk.AccAddress, _ sdk.ValAddress) error {
	return nil
}
