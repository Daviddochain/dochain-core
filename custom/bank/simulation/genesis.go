...
// a balance of simState.InitialStake for appparams.BondDenom and appparams.BondDenom.
func RandomGenesisBalances(simState *module.SimulationState) []types.Balance {
    ...
    for _, acc := range simState.Accounts {
        genesisBalances = append(genesisBalances, types.Balance{
            ...
            Coins: sdk.NewCoins(
                sdk.NewCoin(appparams.BondDenom, simState.InitialStake),
                sdk.NewCoin(appparams.BondDenom, simState.InitialStake),
            ),
        })
    }
...
func RandomizedGenState(simState *module.SimulationState) {
    ...
    supply := sdk.NewCoins(
        sdk.NewCoin(appparams.BondDenom, totalSupply),
        sdk.NewCoin(appparams.BondDenom, totalLunaSupply),
    )
